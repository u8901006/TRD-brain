#!/usr/bin/env python3
"""
Generate TRD (Treatment-Resistant Depression) daily report HTML using NVIDIA AI.
...
SYSTEM_PROMPT = (
    "你是精神醫學領域的資深研究員，專精於難治型憂鬱症 (Treatment-Resistant Depression, TRD) 的臨床研究與學術文獻分析。你的任務是：\n"
    "1. 從提供的醫學文獻中，篩選出與 TRD 最相關且最具臨床意義與研究價值的論文\n"
...
{{
  "date": "{date_str}",
  "market_summary": "2-3句話總結今天 TRD 文獻的整體趨勢與亮點，包含重要的臨床發現",
  "top_picks": [
    {{
      "rank": 1,
      "title_zh": "中文標題",
...
<title>TRD Brain · 難治型憂鬱症文獻日報 · {date_display}</title>
...
<div class="container">
  ...
  <footer>
    ...
    <span><a href="https://github.com/u8901006/TRD-brain">GitHub</a></span>
  </footer>
</div>
</body>
</html>"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate TRD daily report HTML")
    ...
    if not papers_data or not papers_data.get("papers"):
        ...
        analysis = {
            ...
            "market_summary": "今日 PubMed 暫無新的難治型憂鬱症 (TRD) 相關文獻更新。請明天再查看。",
            "top_picks": [],
            "all_papers": [],
            "keywords": [],
            "topic_distribution": {},
